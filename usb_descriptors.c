...
const USB_Descriptor_Device_t PROGMEM DeviceDescriptor =
{
	...
	.ProductID		        = 0x0003,  // 0x0001 MF Classic, 0x0002 MF Pro BM, 0x0003 MF Pro CM, 0x0004 MF Pro SN5
    .ReleaseNumber          = VERSION_BCD(00.02),
    .ManufacturerStrIndex   = 0x01,
    .ProductStrIndex        = 0x02,
    .SerialNumStrIndex      = NO_DESCRIPTOR,
    .NumberOfConfigurations = FIXED_NUM_CONFIGURATIONS
#elif defined(MF_PRO_BEATMASHER)
	.Header                 = { .Size = sizeof(USB_Descriptor_Device_t),
                                .Type = DTYPE_Device },
    .USBSpecification       = VERSION_BCD(01.10),
    .Class                  = 0x00,
    ...
    .Endpoint0Size          = FIXED_CONTROL_ENDPOINT_SIZE,
    .VendorID               = 0x2580,  // DJ Techtools VID
	.ProductID		        = 0x0002,  // 0x0001 MF Classic, 0x0002 MF Pro BM, 0x0003 MF Pro CM, 0x0004 MF Pro SN
    .ReleaseNumber          = VERSION_BCD(00.02),
    .ManufacturerStrIndex   = 0x01,
    .ProductStrIndex        = 0x02,
    .SerialNumStrIndex      = NO_DESCRIPTOR,
    .NumberOfConfigurations = FIXED_NUM_CONFIGURATIONS
#elif defined(MF_PRO_SUPERKNOB)
	.Header                 = { .Size = sizeof(USB_Descriptor_Device_t),
                                .Type = DTYPE_Device },
    .USBSpecification       = VERSION_BCD(01.10),
    .Class                  = 0x00,
    ...
    .Endpoint0Size          = FIXED_CONTROL_ENDPOINT_SIZE,
    .VendorID               = 0x2580,  // DJ Techtools VID
	.ProductID		    	 = 0x0004,  // 0x0001 MF Classic, 0x0002 MF Pro BM, 0x0003 MF Pro CM, 0x0004 MF Pro SN
    .ReleaseNumber          = VERSION_BCD(00.02),
    .ManufacturerStrIndex   = 0x01,
    .ProductStrIndex        = 0x02,
    .SerialNumStrIndex      = NO_DESCRIPTOR,
    ...
    .Endpoint0Size          = FIXED_CONTROL_ENDPOINT_SIZE,
    .VendorID               = 0x2580,  // DJ Techtools VID
	.ProductID		    	= 0x0001,  // 0x0001 MF Classic, 0x0002 MF Pro BM, 0x0003 MF Pro CM, 0x0004 MF Pro SN
    .ReleaseNumber          = VERSION_BCD(00.02),
    .ManufacturerStrIndex   = 0x01,
    .ProductStrIndex        = 0x02,
    .SerialNumStrIndex      = NO_DESCRIPTOR,
...
{
#if defined(MF_PRO_CUEMASTER)
    .Header                 = { .Size = USB_STRING_LEN(27),//27
                                .Type = DTYPE_String },
    .UnicodeString          = L"Midi Fighter Pro Cue Master"
   

#elif defined(MF_PRO_BEATMASHER)
    .Header                 = { .Size = USB_STRING_LEN(28),
                                .Type = DTYPE_String },
    .UnicodeString          = L"Midi Fighter Pro Beat Masher"
#elif defined(MF_PRO_SUPERKNOB)
    .Header                 = { .Size = USB_STRING_LEN(27),
                                .Type = DTYPE_String },
    .UnicodeString          = L"Midi Fighter Pro Super Knob"
#else
