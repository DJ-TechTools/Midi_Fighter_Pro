...
// Device mode effects how the midi fighter sends its MIDI data
extern uint8_t g_device_mode;

// Enabling rotation causes the orrientation of the device to change
// IE a vertical configuration will become horizontal
extern uint8_t g_rotate_enable;
